...
public:
	...
	void getObjBndBoxesForSingleImage(Mat img, ValStructVec<float, Vec4i> &finalBoxes, int numDetPerSize = 100);
...
public: // For illustration etc.
	...
	void myilluTestReults(CStr imgPath, const ValStructVec<float, Vec4i> &boxesTests);
